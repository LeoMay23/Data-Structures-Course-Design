...
template <> constexpr inline auto DrawingArea::qt_create_metaobjectdata<qt_meta_tag_ZN11DrawingAreaE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'adjListUpdated'
        QtMocHelpers::SignalData<void(const std::unordered_map<int,std::list<Edge>> &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void DrawingArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->adjListUpdated((*reinterpret_cast< std::add_pointer_t<std::unordered_map<int,std::list<Edge>>>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DrawingArea::*)(const std::unordered_map<int,std::list<Edge>> & )>(_a, &DrawingArea::adjListUpdated, 0))
            return;
    }
}
...
// SIGNAL 0
void DrawingArea::adjListUpdated(const std::unordered_map<int,std::list<Edge>> & _t1)
{
